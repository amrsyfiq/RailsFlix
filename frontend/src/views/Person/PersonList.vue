...
<template>
  <BreadCrumb menu="People" hrefMenu="persons"/>
  <!-- Start block -->
    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr v-for="(person, index) in personStore.persons" class="border-b border-gray-200 dark:border-gray-700">
              <td class="px-4 py-3">{{ person.name }}</td>
              <td class="px-4 py-3">{{ person.role }}</td>
              <td class="px-4 py-3 flex justify-end">
                <button type="button" @click="initModal(person, 'edit')"
                ...
                <button type="button" @click="initModal(person, 'show')"
                  class="cursor-pointer flex rounded-lg items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
  ...
  <Modal :show="modal.show" @close="modal.show=false">
      ...
      <template #content>
        <PersonForm :data="modal.data" :type="modal.type" @close-modal="modal.show=false"/>
      </template>
  </Modal>
</template>
