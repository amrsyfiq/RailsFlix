...
<template>
  <div class="antialiased bg-gray-50 dark:bg-gray-900 h-screen">
    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <RouterLink to="/" class="flex items-center justify-between mr-4">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white hidden sm:block">RailsFlix</span>
          </RouterLink>
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button type="button" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation"
            class="cursor-pointer p-2 mr-1 text-gray-500 rounded-lg md:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
          ...
          <!-- Dropdown menu -->
          <div
            class="cursor-pointer hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
          ...
          <button type="button" data-dropdown-toggle="apps-dropdown"
            class="cursor-pointer p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
            <span class="sr-only">View notifications</span>
            <!-- Icon -->
          ...
          <!-- Dropdown menu -->
          <div
            class="cursor-pointer hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
            id="apps-dropdown">
            <div
              class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
              Apps
          ...
          <button type="button"
            class="cursor-pointer flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
    ...
    <!-- Sidebar -->
    <aside
      class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700 overflow-hidden"
        ...
        <ul class="space-y-2 mt-4">
          ...
          <li>
            <RouterLink to="/tvshows"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <i class="fas fa-tv text-gray-500 dark:text-gray-400"></i>
              <span class="ml-3">TV Shows</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink to="/persons"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li>
            <RouterLink to="/genres"
              ...
              <i class="fas fa-masks-theater text-gray-500 dark:text-gray-400"></i>
          ...
          <li>
            <a href="#"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
              <i class="fas fa-circle-info text-gray-500 dark:text-gray-400"></i>
    ...
    <main class="max-w-full md:ml-64 px-8 sm:px-16 pt-20 overflow-x-hidden">
      <RouterView />
    </main>
  </div>
</template>
